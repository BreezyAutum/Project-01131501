...
- Learn how to create various simple programs
- Update an ongoing project with new programs
    As well as update previously created programs with new features to either imrpove them in terms of functionality, design, or optimization.
...
This project is for me and me alone, but if you are some who is not me reading this:
- Firstly, Hello!!! Thank you for checking out my project!
- Secondly, if you have any ideas or feedback, please do write it on the GitHub page.
- Thirdly, I'm going at this with the idea that I'll be the only one using this, but I know other people can still see it. This means that I am not expecting anyone other than me to realistically read these notes. If somehow that isn't the case, I'll probably ignore that fact anyway.
- Lastly, despite how I am personally using this project, if you are in fact another human reading this, you may use it for your own use with some minor exceptions:
    Do not use this for AI training AT ALL
...
- README
    ...
    This is the, now, second draft, so I will probably have to edit it or, more likely, format my text differently.
      (I had to do both.)
- Git
